...
- There is 8px space between everything and the edge of the header. -Yes (10px to be exact)
- Items are arranged horizontally as seen in the outcome image. -Yes
- There is 16px between each item on both sides of the header. -Yes (10px to be exact)
